...
export class Backend implements backendInterface {
    ...
    async addTestimonial(arg0: string, arg1: string, arg2: string, arg3: bigint, arg4: boolean): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async getAllUserProfiles(): Promise<Array<ExtendedUserProfile>> {
        if (this.processError) {
            try {
    ...
    async modifyTestimonialVisibility(arg0: bigint, arg1: boolean): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.modifyTestimonialVisibility(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_ExtendedUserProfile_n4(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _ExtendedUserProfile): ExtendedUserProfile {
...
function from_candid_opt_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_ExtendedUserProfile]): ExtendedUserProfile | null {
    return value.length === 0 ? null : from_candid_ExtendedUserProfile_n4(_uploadFile, _downloadFile, value[0]);
}
...
function from_candid_vec_n3(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_ExtendedUserProfile>): Array<ExtendedUserProfile> {
    return value.map((x)=>from_candid_ExtendedUserProfile_n4(_uploadFile, _downloadFile, x));
}
